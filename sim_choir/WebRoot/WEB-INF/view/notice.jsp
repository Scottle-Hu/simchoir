					...
					<div class="inside">
						<nav>
							<ul class="sf-menu">
								...
								<li><a href="announcement.html" class="current"
		...
		<div class="bg_cont1">
			<div class="bg_cont">
				<section id="content">
					<div class="main">
						<div class="inside">
							当前位置：<a href="home.html">首页</a>-<a href="announcement.html">公告</a>-<a
								href="#">公告《${anno.tittle }》</a><br />
							<br />
							<br />
							<div class="container_16">
								<div class="tail2">
									<div class="container">
										<center>
											<h2>${anno.tittle }</h2>
											<h4>发布者：${anno.admin.username }
												&nbsp;&nbsp;&nbsp;日期：${anno.date.substring(0,10)
												}</h4>
										</center>
										<br />
									...
									<br />
									<br /> 上一个公告：
									<c:if test="${priorAnno==null }">
                            	没有了
                            </c:if>
									<c:if test="${priorAnno!=null }">
										<a href="notice.html?annoId=${priorAnno.id }">${priorAnno.tittle
											}</a>
									</c:if>
									<br /> 下一个公告：
									<c:if test="${nextAnno==null }">
                            	没有了
                            </c:if>
									<c:if test="${nextAnno!=null }">
										<a href="notice.html?annoId=${nextAnno.id }">${nextAnno.tittle
											}</a>
									</c:if>
