								...
								<div class="content" style="background-color:black;">
									<article>
										<c:forEach items="${historyList }" var="history">
											<section style="backgroun-color:transparent;">
												<span class="point-time point-red"></span>
												<time datetime="2013-03">
													<span>${history.sdate.substring(0,10) }</span><span>至</span> <span>${history.edate.substring(0,10) }</span>
												</time>
												
												<div style="margin-left:250px;padding-top:20px;padding-bottom:40px;color:black;">
