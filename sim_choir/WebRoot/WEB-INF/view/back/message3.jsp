				...
				<div class="info-center">
					...
					<div class="info-center-con">
						<div class=" info-center-title h5 margin-big-top clearfix">
							<span class="fl padding-large-right"><a href="message.html">全部消息</a></span>
							<span class="fl padding-large-right"><a href="message-already.html">已读消息(${numOfAlready })</a></span>
							<span class="fl  manage-title"><a href="message-wait.html">未读消息(${numOfWait })</a></span>
						</div>
						<p style="width: 56px; left: 20px;margin-left:193px;" class="solid-slider">
						</p>
					</div>
						...
						<c:forEach items="${messageList }" var="message">
							<div class="clearfix">
								...
								<div class=" w15 record">
									<button type="button" onclick="deleteMessage(${message.id })" style="width:80px;height:30px;background-color:red;border-radius:8px;color:white;">删除</button>
