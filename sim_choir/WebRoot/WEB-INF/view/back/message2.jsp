				...
				<div class="info-center">
					...
					<div class="info-center-con">
						<div class=" info-center-title h5 margin-big-top clearfix">
							...
							<span class="fl padding-large-right manage-title"><a href="message-already.html">已读消息(${numOfAlready })</a></span>
							<span class="fl"><a href="message-wait.html">未读消息(${numOfWait })</a></span>
						</div>
						<p style="width: 56px; left: 20px;margin-left:88px;" class="solid-slider">
						</p>
					</div>
						...
						<c:forEach items="${messageList }" var="message">
							<div class="clearfix">
								...
								<div class=" w15 record">
									...
									style="width:80px;height:30px;background-color:red;border-radius:8px;color:white;">删除</button>
